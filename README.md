...
├── specs/             # Test plans generated by the Playwright planner agent
├── .claude/agents/    # Playwright AI testing agents (planner, generator, healer)
...
Next up: Page Object Model, k6 load profiles, JMeter dashboards, and deeper
